...
const sourceCandidates = [
  ...
  path.join(repoRoot, "model", "resnet50_exp2.onnx"),
  path.join(repoRoot, "model", "model.onnx"),
];
const metadataSourceCandidates = [
  path.join(repoRoot, "model", "meatlens_resnet50_exp2_metadata.json"),
  path.join(repoRoot, "model", "resnet50_metadata.json"),
  path.join(repoRoot, "model", "model_metadata.json"),
  path.join(repoRoot, "frontend", "public", "model", "meatlens_resnet50_exp2_metadata.json"),
];
...
const metadataTargetPaths = [
  path.join(repoRoot, "frontend", "public", "model", "meatlens_resnet50_exp2_metadata.json"),
  path.join(repoRoot, "frontend", "public", "models", "resnet50_meat", "meatlens_resnet50_exp2_metadata.json"),
];
